...
BusRequestMessage = GetMessageClass(DescriptorPool.generated_pool().FindMessageTypeByName('bus.BusRequest'))
BusResponseMessage = GetMessageClass(DescriptorPool.generated_pool().FindMessageTypeByName('bus.BusResponse'))
# ─────────────────────────────────────────────────────────────────────
